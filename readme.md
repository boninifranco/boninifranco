...
- **Otros:** Git, GitHub, APIs REST, Testing, RevenueCat, Google Sign-In
...
|----------|-------------|-------------|-------------|
| **Field Cognition** | App móvil de geofísica de campo (SEV, GPS, exportación de datos). En producción en Google Play con cliente real pagando. | Privado — código disponible bajo request | [Google Play](https://play.google.com/store/apps/details?id=com.boninidev.FieldApp) |
| **Laura Pons Seguros** | Landing page para aseguradora, HTML/CSS/JS. | [Ver repositorio](https://github.com/boninifranco/lauraponsseguros) | [Demo Online](http://lauraponsseguros.com.ar) |
